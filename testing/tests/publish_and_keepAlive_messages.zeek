# @TEST-EXEC: touch hart_ip_general.log hart_ip_session_record.log hart_ip_universal_commands.log
# @TEST-EXEC: zeek -C -r ${TRACES}/hart-ip_publish_and_keepAlive.pcapng ${PACKAGE} %INPUT
...
#
# @TEST-DOC: Test hart-ip analyzer with hart-ip_publish_and_keepAlive.pcapng
